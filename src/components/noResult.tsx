...
export default function NoResult() {
  ...
  return (
    <div className="relative w-full h-screen flex flex-col items-center">
      ...
      <div className="mt-28 px-12 flex flex-col items-start justify-start w-full ">
        <img 
          src="/assets/noResult/PC_header_t.svg"
          alt="Header"
          className="h-[67.80px] mb-4"
        />
      ...
      <div className="flex flex-col items-center justify-center h-full">
        <div className="font-pretendard flex flex-col items-center">
          ...
          />
          <span className="text-[30px] font-semibold font-pretendard leading-[60px] mb-4">검색 결과가 없습니다.<br/></span>
