...
import GridViewTest from '../grid/GridViewTest';
import PaginationControl from './PaginationControl';
import useResponsiveItemsPerPage from '@/hooks/useResponsiveItemsPerPage';
import { notFound } from 'next/navigation';

/**
 * PaginationTest 컴포넌트는 주어진 콘텐츠를 그리드 형식으로 페이징 처리하여 렌더링합니다.
...
export default function PaginationTest<T>({
  contents,
  GridItem,
  webItemPerPage,
  mobileItemPerPage,
