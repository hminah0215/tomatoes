...
export default function BusinessIntro() {
  return (
    <>
      <div>
        {/* 상단 타이틀 */}
        <div className="h-[72px] text-sub-gray-500 text-5xl font-bold mt-[88px]">
          사업소개
        </div>

        {/* 구분선 */}
        <div className="w-[999px] h-[1px] bg-sub-gray-200 mt-4 mb-[40px]" />
        ...
        <div className="relative w-[999px] h-[295px] bg-point-red-100 rounded-[20px] flex items-center justify-between p-8">
          ...
          <div>
            <Image
              ...
              height={60}
            />
            <div className="mt-4 mb-[44px] text-sub-gray-500 text-[32px] font-bold">
              멋쟁이 토마토가 될 당신을 위해
            </div>

            {/* 다운로드 버튼 */}
            <button className="w-[318px] h-16 bg-transparent rounded-[100px] border-2 border-point-red-500 flex justify-center items-center gap-2.5 focus:outline-none">
              <span className="text-point-red-500 text-[32px] font-semibold">
                회사소개서 다운로드
              </span>
            </button>
          </div>
          ...
          {/* 토마토 이미지 */}
          <div className="absolute right-[44px] top-9">
            <Image
        ...
        <div className="container w-[1000px]">
          <section className="mt-[72px] mb-[80px] flex">
            <div className="w-1/3">
              <h2 className="text-[28px] font-bold text-sub-gray-500 mb-2">
                디자인산업 <br />
                <span className="text-point-red-500">육성 지원사업</span>
              </h2>
            </div>
            <div className="w-2/3">
          ...
          <section className="mb-[80px] flex">
            <div className="w-1/3">
              <h2 className="text-[28px] font-semibold text-sub-gray-500 mb-2">
          ...
          <section className="flex">
            <div className="w-1/3">
              <h2 className="text-[28px] font-semibold text-point-red-500 mb-2">
          ...
          {/* 구분선 */}
          <div className="w-[999px] h-[1px] bg-sub-gray-200 mt-[90px] mb-[80px]" />
          ...
          {/* 광고/제휴 문의 버튼 */}
          <div className="flex justify-center mt-[40px] mb-[92px]">
