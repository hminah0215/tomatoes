...
export default function TabItem({ tab, isActive, onClick }: TabItemProps) {
  const baseClasses =
    'cursor-pointer relative pb-2 px-[2px] text-lg md:text-[26px] leading-normal font-semibold after:content-[""] after:absolute after:left-0 after:bottom-[-2px] after:rounded-full after:transition-all after:duration-300';
